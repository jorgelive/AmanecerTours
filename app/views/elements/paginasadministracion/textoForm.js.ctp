			var textoForm = new Ext.FormPanel({ 
				...
				,items:[{
					...
					,tinymceSettings: {
						...
						,theme_advanced_buttons1: "bold,italic,underline,strikethrough,|,justifyleft,justifycenter,justifyright,justifyfull,|,formatselect,fontselect,fontsizeselect,|,help,|,preview"
