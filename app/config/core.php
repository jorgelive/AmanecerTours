 ...
 */
	Configure::write('Security.salt', 'cuscofIxfs2guVoUubWwvniR2G0FgaC9mi');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '08476859309657453542496749683645');
 ...
 */
	...
	Configure::write('Default.video',array('Youtube','Vimeo'));
	Configure::write('Config.language',Configure::read('Empresa.language'));///este es sobreescrito con idioma
?>